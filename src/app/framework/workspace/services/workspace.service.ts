...
export class WorkspaceService {
  ...
  open(screen: Screen) {
    ...
    const newId = this.state.tabSequence() + 1;
    this.state.tabSequence.set(newId);
  ...
  duplicate(tabId: string): void {
    ...
    const nextId = this.state.tabSequence() + 1;
    this.state.tabSequence.set(nextId);
