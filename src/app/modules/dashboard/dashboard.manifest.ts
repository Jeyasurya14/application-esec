...
import { AgentLinuxComponent } from "./components/agent-linux/view/agent-linux.component";
import { AgentWindowComponent } from "./components/agent-windows/view/agent-windows.component";
...
export const dashboardManifest: ModuleRegistration = defineModule({
...

  {
    ...
    icon: 'bi bi-windows',
    sidebar_title,
    component:AgentWindowComponent
  },
